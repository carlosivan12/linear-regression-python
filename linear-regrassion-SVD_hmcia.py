...
1.    Para el primer punto, una vez leido el articulo y buscado en internet. Se ha determinado por escoger un data set de kaggle.com, el cual cumple con un patron lineal de los datos expuestos de manera multivariable. Este data set, esta hecho para predecir las ventas de compañias en funcion del presupuesto de marketing invertido en redes sociales (youtube, facebook y periodico), por lo cual, a manera de puesta en practica y demostracion, es un grupo de datos muy interesante para probar la regresion lineal multivariable.
...
from google.colab import drive #Se conecta colab con google drive para poder importar el dataset que, según requerimientos, pide ir en la misma carpeta del codigo, por lo cual al momento de subir la carpeta para calificar, 
#se solicita amablemente subir la carpeta en  el inicio de google drive, de acuerdo a la ruta establecida para leer el data set. 
...
"""Se puede observar que el accuracy mejor dado es el Nadam con 0.84
